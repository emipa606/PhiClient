...
namespace PhiClient
{
	...
	public abstract class Packet
	{
		...
		{
			RealmContext realmContext = new RealmContext
			{
				realmData = realmData,
				user = user
			};
			BinaryFormatter binaryFormatter = new BinaryFormatter(null, new StreamingContext(StreamingContextStates.All, realmContext));
